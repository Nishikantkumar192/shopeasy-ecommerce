...
router.post("/newItem",validateProduct,isUserExist,isAdmin,upload.single("image"),newItem);
router.get("/updateItemInformation/:id",isUserExist,isAdmin,getItemDetails);
router.put("/updateItemInformation/:id",validateProduct,isUserExist,isAdmin,upload.single("image"),updateItemInformation);
