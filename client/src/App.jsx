    ...
    <NoteState>
      <Router>
        ...
        <Routes>
          ...
          <Route exact path="/addItem" element={<ProductItem heading="Add new product" type="add" work="Add product"/>}/>
          <Route exact path="/UpdateProductDetails/:id" element={<UpdateProductDetails/>}/>
